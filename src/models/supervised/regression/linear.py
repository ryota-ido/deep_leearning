...
class LinearRegression(BaseModel):
    ...
    Provides a wrapper around sklearn's LinearRegression with
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        Args:
            config: Configuration dictionary with model parameters.
                   Allows customization of LinearRegression initialization.
        """
    ...
    def init_model(self):
        """
        Initialize the underlying sklearn LinearRegression model.

        Uses parameters from self.get_params to configure the model,
        allowing flexible model initialization.
        """
        self._model = SklearnLinearRegression(**self.get_params())
